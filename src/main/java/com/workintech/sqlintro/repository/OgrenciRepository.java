...
public interface OgrenciRepository extends JpaRepository<Ogrenci, Long> {
    ...
    String QUESTION_3 = "SELECT DISTINCT sinif FROM ogrenci WHERE sinif IS NOT NULL";
    ...
    String QUESTION_5 = "SELECT * FROM ogrenci WHERE ogrno >= 5 AND ogrno <= 10 AND cinsiyet = 'K' ORDER BY ad ASC";
    ...
    String QUESTION_8 = "SELECT * FROM ogrenci WHERE dtarih IS NOT NULL ORDER BY dtarih DESC LIMIT 1";
    @Query(value = QUESTION_8, nativeQuery = true)
    Ogrenci findYoungestStudent();

    //Öğrenciler tablosundaki en yaşlı öğrenciyi listeleyiniz.
    String QUESTION_9 = "SELECT * FROM ogrenci WHERE dtarih IS NOT NULL ORDER BY dtarih ASC LIMIT 1";
